...
_这份参考教程列出了 MST 暴露的所有方法。 Contributions like linguistic improvements, adding more details to the descriptions or additional examples are highly appreciated! 请注意文档是通过源码生成的，大部分的方法都定义在 [mst-operations.ts](https://github.com/mobxjs/mobx-state-tree/blob/master/src/core/mst-operations.ts) 文件中。_
